...
jQuery(document).ready(function () {
  function detect_active() {
    ...
    var active_content = $(`*[data-class=${get_active}]`);
    active_content.addClass("_active");
    return get_active;
  }
  $("#dp-next").click(function () {
    ...
    $.each($(".dp_item:not(:first-child)"), function (index, dp_item) {
      $(dp_item).removeClass("_active");
    });
    detect_active();
  });
...
jQuery(document).ready(function () {
  function detect_active() {
    // get active
    var get_active = $(".content-main__slider .content-main__slide:first-child").data("class");
    var active_content = $(`*[data-class=${get_active}]`);
    active_content.addClass("_active");
    return get_active;
  }
  $("#dp-next").click(function () {
    $(".content-main__slider .content-main__slide:first-child").hide().appendTo(".content-main__slider").fadeIn();
    $.each($(".content-main__slide"), function (index, dp_item) {
      $(dp_item).attr("data-position", index + 1);
    });
    $.each($(".content-main__slide:not(:first-child)"), function (index, dp_item) {
      $(dp_item).removeClass("_active");
    });
    detect_active();
  });
  ...
  $("#dp-prev").click(function () {
    $(".content-main__slider .content-main__slide:last-child").hide().prependTo(".content-main__slider").fadeIn();
    $.each($(".content-main__slide"), function (index, dp_item) {
      $(dp_item).attr("data-position", index + 1);
    });
    $.each($(".content-main__slide:not(:first-child)"), function (index, dp_item) {
  ...
  $("body").on("click", ".content-main__slider .content-main__slide:not(:first-child)", function () {
    return;
  });
});
...
const hangPoint = document.querySelector(".dp_item._active");
const sliderArrows = document.querySelector(".home-intro__slider .slider-main__controls");
const stickArrowsToSlideCorner = () => {
  const parentPos = hangPoint.getBoundingClientRect();
  const childPos = sliderArrows.getBoundingClientRect();
  // let relativePos = {};
  ...
  if (parentPos && childPos) {
    ...
    sliderArrows.style.cssText = `bottom:${bottom}px;z-index:1000`;

    if (window.innerWidth < 710) {
      sliderArrows.style.cssText = `left:${Math.abs(parentPos.left)}px;bottom:${bottom}px;z-index:1000`;
    }
...
stickArrowsToSlideCorner();

window.addEventListener("resize", stickArrowsToSlideCorner);
// ==========================================================

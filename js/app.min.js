...
if (document.querySelector(".slider-news__body")) {
  new Swiper(".slider-news__body", {
    ...
    shortSwipes: false,
    navigation: {
      nextEl: ".slider-news__controls .slider-arrow_next",
      prevEl: ".slider-news__controls .slider-arrow_prev",
    },
    breakpoints: {
      320: {
        slidesPerView: 1,
...
// Video player - About Company=====
const videoAbout = document.getElementById("video-about");
const videoAboutPlayButton = document.querySelector(".video-about__playpause-button");

// function playVideo(vid) {
//   videoAbout.play();
// }

// function pauseVideo(vi) {
//   videoAbout.pause();
// }

if (videoAbout) {
  videoAbout.addEventListener("click", () => {
    if (videoAbout.paused == false) {
      videoAboutPlayButton.style.opacity = 1;
      videoAbout.pause();
      videoAbout.firstChild.nodeValue = "Play";
    } else {
      videoAboutPlayButton.style.opacity = 0;

      videoAbout.play();
      videoAbout.firstChild.nodeValue = "Pause";
    }
  });
}
